...
<div class="project-card">
    <h3>ActSustainably, Biodiversa+ Project</h3>
      <p>
        ActSustainably just launched: a four-country study of grassland governance across Eurasia (Austria/South Tyrol, Denmark, Hungary, Kazakhstan), examining how formal institutions, informal rules, and competing values shape land use and identifying where the real leverage points for change might be. Grasslands are among the most threatened and least protected ecosystems, and the project combines remote sensing, institutional analysis, and participatory work with local communities to figure out what's driving their decline (and what could turn it around). My part of the project covers three angles:
      </p>
      <ul>
